...
func loadSnapshot(config *params.CliqueConfig, sigcache *lru.ARCCache, db trcndb.Database, hash common.Hash) (*Snapshot, error) {
...
func (s *Snapshot) store(db trcndb.Database) error {
