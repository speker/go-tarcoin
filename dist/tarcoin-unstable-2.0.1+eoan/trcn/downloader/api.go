...
// Syncing provides information when this nodes starts synchronising with the TarCoin network and when it's finished.
...
type SyncingResult struct {
	...
	Status  tarcoin.SyncProgress `json:"status"`
}
