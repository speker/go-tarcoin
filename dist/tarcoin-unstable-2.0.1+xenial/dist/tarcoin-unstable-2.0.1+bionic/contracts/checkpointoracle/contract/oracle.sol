 ...
 * @author Gary Rong<garyrong@tarcoin.org>, Martin Swende <martin.swende@tarcoin.org>
...
contract CheckpointOracle {
    ...
    */
    ...
    //
    // The default value should be the same as the checkpoint size(32768) in the tarcoin.
    uint sectionSize;
