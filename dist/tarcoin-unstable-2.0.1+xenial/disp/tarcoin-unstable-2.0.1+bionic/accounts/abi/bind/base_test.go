...
func (mc *mockCaller) CallContract(ctx context.Context, call tarcoin.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (mc *mockCaller) PendingCallContract(ctx context.Context, call tarcoin.CallMsg) ([]byte, error) {
