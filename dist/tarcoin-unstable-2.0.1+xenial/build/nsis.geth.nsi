...
# 1. install gtrcn for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for gtrcn
# 5. create gtrcn, attach and uninstall start menu entries
...
!define GROUPNAME "TarCoin"
!define APPNAME "Gtrcn"
!define DESCRIPTION "Official Go implementation of the TarCoin protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since gtrcn is installed global
