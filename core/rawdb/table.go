...
func NewTable(db trcndb.Database, prefix string) trcndb.Database {
	return &table{
		db:     db,
		prefix: prefix,
	}
...
func (t *table) NewIterator(prefix []byte, start []byte) trcndb.Iterator {
...
func (t *table) NewBatch() trcndb.Batch {
...
func (b *tableBatch) Replay(w trcndb.KeyValueWriter) error {
