...
// account array.
func checkStateAccounts(t *testing.T, db trcndb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db trcndb.Database, root common.Hash) error {
...
func checkStateConsistency(db trcndb.Database, root common.Hash) error {
...
func TestIncompleteStateSync(t *testing.T) {
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(trcndb.Database), srcRoot)
