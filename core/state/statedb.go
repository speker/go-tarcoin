...
// Package state provides a caching layer atop the TarCoin state trie.
package state
...
// StateDBs within the tarcoin protocol are used to store anything
...
func (s *StateDB) Copy() *StateDB {
	...
	for addr := range s.journal.dirties {
		// As documented [here](https://github.com/spker/go-tarcoin/pull/16485#issuecomment-380438527),
