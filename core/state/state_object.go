...
// stateObject represents an TarCoin account which is being modified.
//
...
type stateObject struct {
	...
	addrHash common.Hash // hash of tarcoin address of the account
	data     Account
	db       *StateDB
...
// Account is the TarCoin consensus representation of accounts.
