...
func wipeSnapshot(db trcndb.KeyValueStore, full bool) chan struct{} {
...
func wipeContent(db trcndb.KeyValueStore) error {
...
func wipeKeyRange(db trcndb.KeyValueStore, kind string, prefix []byte, keylen int) error {
