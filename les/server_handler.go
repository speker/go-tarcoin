...
const (
	...
	ethVersion        = 63              // equivalent trcn version for the downloader
...
func newServerHandler(server *LesServer, blockchain *core.BlockChain, chainDb trcndb.Database, txpool *core.TxPool, synced func() bool) *serverHandler {
