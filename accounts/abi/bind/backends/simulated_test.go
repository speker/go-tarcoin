...
func TestNewSimulatedBackend(t *testing.T) {
	...
	if sim.config != params.AllTrcnhashProtocolChanges {
		t.Errorf("expected sim config to equal params.AllTrcnhashProtocolChanges, got %v", sim.config)
	}

	if sim.blockchain.Config() != params.AllTrcnhashProtocolChanges {
		t.Errorf("expected sim blockchain config to equal params.AllTrcnhashProtocolChanges, got %v", sim.config)
	}
