...
// Whisper represents a dark communication interface through the TarCoin
...
// New creates a Whisper client ready to communicate through the TarCoin P2P network.
