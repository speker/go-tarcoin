...
func TestCheckCompatible(t *testing.T) {
	...
	tests := []test{
		{stored: AllTrcnhashProtocolChanges, new: AllTrcnhashProtocolChanges, head: 0, wantErr: nil},
		{stored: AllTrcnhashProtocolChanges, new: AllTrcnhashProtocolChanges, head: 100, wantErr: nil},
		{
		...
		{
			stored: AllTrcnhashProtocolChanges,
