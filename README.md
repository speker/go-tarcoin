...
|   `puppeth`   | a CLI wizard that aids in creating a new TarCoin network.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
If you'd like to contribute to go-tarcoin, please fork, fix, commit and send a pull request
