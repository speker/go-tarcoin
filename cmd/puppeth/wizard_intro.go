...
// setting up a new or managing an existing TarCoin private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your TarCoin private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new TarCoin network down to  |")
	fmt.Println("| the genesis block, bootnodes, miners and trcnstats servers |")
	...
	log.Info("Administering TarCoin network", "name", w.network)
