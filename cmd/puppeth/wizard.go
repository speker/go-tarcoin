...
type wizard struct {
	...
	services map[string][]string   // TarCoin services known to be running on servers
...
// converts it to an TarCoin address. If an empty line is entered, the default
// value is returned.
...
// weird formats used by trcnstats, which compares IPs textually, not by value.
