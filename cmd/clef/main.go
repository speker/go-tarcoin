...
import (
	...
	"github.com/spker/go-tarcoin/signer/fourbyte"
	"github.com/spker/go-tarcoin/signer/rules"
...
func init() {
	app.Name = "Clef"
	app.Usage = "Manage TarCoin account operations"
	app.Flags = []cli.Flag{
		logLevelFlag,
		keystoreFlag,
		configdirFlag,
...
func GenDoc(ctx *cli.Context) {
	...
	{ // WHen a signed tx is ready to go out
		...
		add("OnApproved - SignTransactionResult", desc, &trcnapi.SignTransactionResult{Raw: rlpdata, Tx: &tx})
