...
```shell
go get github.com/ethereum/go-tarcoin/cmd/checkpoint-admin
```
...
*CHECKPOINT_HASH is obtained based on this [calculation method](https://github.com/ethereum/go-tarcoin/blob/master/params/config.go#L251).*
